...
SELECT city.city_id, customer.first_name, customer.last_name, customer.email, address.address, address.district
FROM customer
...
SELECT store.store_id, address.city_id, customer.first_name, customer.last_name, customer.email, address.address, address.district
FROM customer
...
-- 7. What query would you run to get all drama films with 
-- a rental rate of 2.99? Your query should return film title, 
